  ...
  const createUserProfile = async (user, displayName) => {
    try {
      ...
      const userData = {
        ...
        email: user.email,
        name: displayName || user.displayName || formData.name || "",
        profilePicture: user.photoURL || "",
      };

      console.log('User data:', userData);

      // ✅ FIXED: Changed from /api/users to /api/auth/register
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      try {
        ...
        // User might already exist in database, which is fine
        console.log('User profile already exists or error:', profileError);
      }
