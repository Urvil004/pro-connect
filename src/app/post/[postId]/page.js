    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center transition-colors duration-300">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600 dark:text-gray-400 font-medium">Loading post...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="mb-6 flex items-center justify-between">
          ...
          <div className="flex space-x-2">
            <Button
              ...
              size="sm"
              onClick={handleShare}
              className="flex items-center space-x-2 text-gray-900 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700"
            >
